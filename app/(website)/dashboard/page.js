    ...
    return (
        <section className='py-6'>
            <Box>
                ...
                <div>
                    <div className='flex flex-col w-full px-4 py-4 -mx-4 overflow-x-auto sm:-mx-8 sm:px-8 h-screen'>
                        <div className='p-4 border rounded-xl inline-block min-w-full overflow-hidden'>
                            {posts.length === 0 ? (
                                <p className="text-gray-800 text-center mt-8">You haven't posted anything yet. Why not post your first blog?</p>
                            ) : (
